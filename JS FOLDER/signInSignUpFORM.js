...
function updateHeaderUser() {
    const userIconDiv = document.querySelector('.headerGroup > div:last-of-type');
...
// save sign up form's original HTML to restore later
const signUpOriginalHTML = document.querySelector('.signUpForm').innerHTML;
